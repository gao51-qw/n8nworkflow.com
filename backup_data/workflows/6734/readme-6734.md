...
- **Source:** [View on n8n.io](https://n8n.io/workflows/6734)
...
- **aggregate** (×3)
- **filter** 
- **@n8n/n8n-nodes-langchain.outputParserStructured** (×7)
- **mongoDb** (×27)
- **code** (×26)
- **httpRequest** (×4)
- **splitInBatches** (×3)
...
This workflow contains 144 nodes with 119 node connections.
