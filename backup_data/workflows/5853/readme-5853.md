...
This workflow enables WhatsApp-based interaction with Google Calendar. Users can:
- Create new events
...
### Setup
1. Add credentials:
   - WhatsApp: Connect your WhatsApp API (OAuth or other supported method).
...
- **Source:** [View on n8n.io](https://n8n.io/workflows/5853)
