...
2. **Credentials** Add Wayback API credentials
...
• **GET /wayback/v1/available**: GET /wayback/v1/available
• **POST /wayback/v1/available**: POST /wayback/v1/available
...
- **Source:** [View on n8n.io](https://n8n.io/workflows/5536)
