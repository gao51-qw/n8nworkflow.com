...
- **Source:** [View on n8n.io](https://n8n.io/workflows/9128)
...
- **@n8n/n8n-nodes-langchain.textClassifier** (×4)
- **microsoftOutlook** (×26)
- **microsoftExcel** 
- **set** (×4)
- **microsoftOutlookTool** (×2)
...
This workflow contains 79 nodes with 49 node connections.
