...
- **Source:** [View on n8n.io](https://n8n.io/workflows/6019)
...
- **@n8n/n8n-nodes-langchain.embeddingsAzureOpenAi** (×6)
...
- **googleSheets** 
- **@n8n/n8n-nodes-langchain.rerankerCohere** (×4)
- **extractFromFile** 
- **if** 
- **googleSheetsTool** 
...
This workflow contains 49 nodes with 37 node connections.
