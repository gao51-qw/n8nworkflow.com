...
> Complete MCP server exposing 1 Image Moderation API operations to AI agents.
...
2. **Credentials** Add Image Moderation credentials
...
**Response Format**: Native Image Moderation API responses with full data structure
...
- **Source:** [View on n8n.io](https://n8n.io/workflows/5661)
