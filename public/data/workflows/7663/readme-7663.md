...
- **Source:** [View on n8n.io](https://n8n.io/workflows/7663)
...
- **@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas** (×3)
- **@n8n/n8n-nodes-langchain.lmChatGoogleGemini** (×3)
- **@n8n/n8n-nodes-langchain.lmChatOpenRouter** (×2)
- **gmailTool** (×2)
- **googleTasksTool** (×3)
- **httpRequestTool** (×3)
- **@brave/n8n-nodes-brave-search.braveSearchTool** (×2)
...
- **webhook** (×2)
- **convertToFile** 
- **@n8n/n8n-nodes-langchain.lmChatVercelAiGateway** (×5)
...
This workflow contains 71 nodes with 61 node connections.
