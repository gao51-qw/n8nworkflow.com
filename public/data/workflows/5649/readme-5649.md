...
2. **Credentials** Add Article Search API credentials
...
### 🔧 Articlesearch.Json (1 endpoints)

• **GET /articlesearch.json**: Search Articles
...
**Response Format**: Native Article Search API responses with full data structure
...
- **Source:** [View on n8n.io](https://n8n.io/workflows/5649)
