...
- **Source:** [View on n8n.io](https://n8n.io/workflows/6186)
...
- **@n8n/n8n-nodes-langchain.toolWorkflow** (×25)
- **@n8n/n8n-nodes-langchain.memoryBufferWindow** (×26)
- **@n8n/n8n-nodes-langchain.agent** (×26)
- **@n8n/n8n-nodes-langchain.toolHttpRequest** (×21)
- **stickyNote** (×8)
- **set** (×4)
- **whatsApp** 
- **whatsAppTrigger** 
- **@n8n/n8n-nodes-langchain.lmChatOpenAi** (×26)
...
This workflow contains 214 nodes with 180 node connections.
