...
- **Source:** [View on n8n.io](https://n8n.io/workflows/6960)

## 👤 Author

- **Name:** Charles
- **Username:** @lepoittevin
...
- **telegramTrigger** 
- **n8n-nodes-magic-inbox.magicInboxSend** (×2)
- **n8n-nodes-magic-inbox.magicInbox** (×2)
- **stickyNote** (×8)
- **telegram** 
- **manualTrigger** 
- **n8n-nodes-magic-dev.magicDev** 
...
This workflow contains 16 nodes with 3 node connections.
