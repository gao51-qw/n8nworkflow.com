...
> Complete MCP server exposing 2 topupsapi API operations to AI agents.
...
2. **Credentials** Add topupsapi credentials
...
• **GET /questions**: Create Question 1
...
**Response Format**: Native topupsapi API responses with full data structure
...
- **Source:** [View on n8n.io](https://n8n.io/workflows/5641)
